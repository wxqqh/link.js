(function(global) {
    ...
    var distribute = function(instance, context) {
        ...
        var next = function() {
            ...
            current++;
            if (interceptor && (!interceptor.cmd || interceptor.cmd === context.type)) {
    ...
    Link.prototype.use = function(cmd, interceptor) {
        Link.addIntercept(this.$config.interceptors, cmd, interceptor);
        return this;
    };
    ...
    Link.use = function(cmd, interceptor) {
        Link.addIntercept(Link.globalInterceptors, cmd, interceptor);
    };
